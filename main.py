...
from utils import update_gps_map
...
class SensorFusion:
    def __init__(self):
        ...
        self.gps_data = {"timestamp": None, "lat": 0, "lon": 0, "alt": 0, "sats": 0, "last_map_update": 0}
    ...
    def start_threads(self):
        ...
        self.threads = [
            ...
            threading.Thread(target=gps_thread_func, args=(self.gps_serial_port, self.gps_data_lock, self.gps_data, self.stop_event, self.config, update_gps_map), daemon=True),
    ...
    def run(self):
        ...
        try:
            ...
            self.fig_lidar, self.fig_accel, self.lidar_ani, self.accel_ani = setup_visualization(self.lidar_data, self.lidar_data_lock, self.accel_data, self.accel_data_lock, self.config)
